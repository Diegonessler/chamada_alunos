...
import '../utils/relatorio_util.dart';
...
class _HistoricoScreenState extends State<HistoricoScreen> {
  ...
  void exportarRelatorio() {
    if (aluno != null) {
      final listaPresenca = gerarListaPresencaCSV(aluno!);
      RelatorioUtil.gerarCSV(listaPresenca, 'relatorio_chamada');
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Relatório CSV gerado com sucesso!')),
      );
    }
  }

  List<Map<String, String>> gerarListaPresencaCSV(Aluno aluno) {
    ...
    final listaCSV = <Map<String, String>>[];
    agrupadoPorData.forEach((data, rodadas) {
      rodadas.forEach((rodada, status) {
        listaCSV.add({
          'nome': aluno.nome,
          'data': data,
